...
本项目采用 **双许可模式**(Fair-code):

- 默认许可:[PolyForm Noncommercial License 1.0.0](./LICENSE)(非商业免费);
- 商业用途需[商业授权](./COMMERCIAL-LICENSE.md)。

**提交 PR 即表示你同意**:你贡献的代码(含文档)按上述许可发布,并授权
项目维护者在双许可框架下使用、分发与再授权(包括为商业用途单独授权)。
如不同意,请勿提交。
